$(document).ready(function(e) {CalendarHandler.initialize();});
        ...
        var CalendarHandler = {
            ...
            initialize: function() {
                ...
                $("#dateContainer").append($calendarItem);
                ...
                $("#dateContainer").css("height", "0px").css("width", "0px").css("margin-left", $("#context").width() / 2 + "px").css("margin-top", ($("#context").height() - 30) / 2 + "px");
                $("#dateContainer").animate({
                ...
                $(".currentItem>a").css("margin-left", ($(".date-item").width() - 25) / 2 + "px").css("margin-top", ($(".date-item").height() - 25) / 2 + "px");
            ...
            CreateSelectYear: function(showYearStart) {
                ...
                for (var i = showYearStart; i < showYearStart+12; i++) {
                    ...
                    $yearItem.click(function(){
                        ...
                        $($("#dateContainer").find(".dayItem")[0]).animate({
                        height: "0px"
                        }, 300, function() {
                        $(this).remove();
            ...
            CreateCalendar: function(y, m, d) {
                ...
                if (nowWeek != 0) {
                    ...
                    for (var i = (lastMonthDaysNub - (nowWeek - 1)); i < lastMonthDaysNub; i++) {
                        $dayItem.append("<div class=\"date-item lastItem\"><a>" + (i + 1) + "</a></div>");
                    }
                }
                ...
                for (var i = 0; i < nowDaysNub; i++) {
                    ...
                    else $dayItem.append("<div class=\"date-item\"><a>" + (i + 1) + "</a></div>");
                }
